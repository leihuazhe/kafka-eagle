...
public class DateUtils {
    ...
    public static final String ES_TIME_FORMAT = "MM-dd HH:mm:ss";
    public static final String ES_INDEX_FORMAT = "yyyy.MM.dd";
...
/*    public static String getTimeStamp(Date date) {
    ...
    public static boolean isSameDay(Date date1, Date date2) {
        return parseDateToString(date1, DATE_FORMAT).equalsIgnoreCase(parseDateToString(date2, DATE_FORMAT));
    }
     ...
     * @return: Date
     */
    public static Date getDateChangeMin(Date date, int num) {
        Calendar ca = Calendar.getInstance();
        ca.setTime(date);
    ...
    public static void main(String[] arg0) {
        System.out.println(parseDateToString(new Date(), DATE_TIME_FORMAT));

        System.out.println(StringToDate(parseDateToString(new Date(), DATE_TIME_FORMAT), DATE_TIME_FORMAT));
        System.out.println(parseDateToString(StringToDate(parseDateToString(new Date(), DATE_TIME_FORMAT), DATE_TIME_FORMAT), DATE_TIME_FORMAT));
    }
